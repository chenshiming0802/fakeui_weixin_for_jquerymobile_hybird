...
IScrollLoadData.prototype.pullDownAction=function(){
	...
	if(this.dropTopAction){
		...
		this.dropTopAction();//add by chenshiming
		this.refresh('top');//add by chenshiming		
	}else{
		this.refresh('top');
	} 
};
IScrollLoadData.prototype.pullUpAction=function(){
	...
	if(this.dropBottomAction){
		...
		this.dropBottomAction();//add by chenshiming
		this.refresh('bottom');//add by chenshiming
